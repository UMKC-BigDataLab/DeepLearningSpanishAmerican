...
conv_base = InceptionV3(weights = None, include_top=False, input_shape=(200,200,3))
conv_base.summary()
...
#	epochs=EPOCHS,verbose=1,callbacks=[tensorboard_callback,checkpoint])
#training :)
...
#print("Average Validation Accuracy: %.2f%%" % scores*100)
#avg_acc = np.mean(acc)
#print("Average Training Accuracy: %.2f%%" % avg_acc*100)
...
#plt.legend()
#plt.figure()
#plt.savefig("V3_model_plot1.png")
#Train and validation loss
#plt.plot(epochs, loss, 'b', label='Training loss')
#plt.plot(epochs, val_loss, 'r', label='Validation loss')
#plt.title('Training and Validation loss')
#plt.legend()
#plt.savefig("V3_model_plot2.png")
